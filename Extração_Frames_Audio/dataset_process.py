...
from globals_and_functions import *
...
try:
    ...
    dataset_raw_datapath = [f for f in listdir(os.path.join( CONST_STR_DATASET_RAW_DATAPATH)) if isfile(join(os.path.join( CONST_STR_DATASET_RAW_DATAPATH), f))]
