#CUDA_VISIBLE_DEVICES=2 python train_teste.py
...
SCHEDULER = True #LR Scheduler
NUMBER_STEPS_EPOCHS = 30
lr_scheduler = [1e-04,5e-05,1e-05]


name_Folds = 'f4' #10F , 308, 344, LM, -> para mudar o dataset de teste mudar o arquivo folds_teste
#f4 é fold 4 presente no 10F
folds_number = 1 #Se for treino a quantidade em name_Fols, se for teste, a quantidade de Folds do treino


# Constantes 
LSTM =  True
FEATURES = 'MatheusNaotoF'
